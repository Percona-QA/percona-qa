...
if [ "$1" != "" ]; then
  ...
  sudo docker exec -it $(sudo docker ps -a | grep pmm | grep 'Up.*pmm-server' | sed 's|[ \t].*||') cat /opt/VERSION | grep -v '^$' | sed 's|^|  |'
  echo '==================== Extended info: cat /var/log/nginx/error.log inside docker container:'
  sudo docker exec -it $(sudo docker ps -a | grep pmm | grep 'Up.*pmm-server' | sed 's|[ \t].*||') cat /var/log/nginx/error.log | grep -v '^$' | sed 's|^|  |'
  echo '==================== Extended info: cat /var/log/consul.log inside docker container:'
  sudo docker exec -it $(sudo docker ps -a | grep pmm | grep 'Up.*pmm-server' | sed 's|[ \t].*||') cat /var/log/consul.log | grep -v '^$' | sed 's|^|  |'
  echo '==================== Extended info: cat /var/log/grafana.log inside docker container:'
  sudo docker exec -it $(sudo docker ps -a | grep pmm | grep 'Up.*pmm-server' | sed 's|[ \t].*||') cat /var/log/grafana.log | grep -v '^$' | sed 's|^|  |'
  echo '==================== Extended info: cat /var/log/prometheus.log inside docker container:'
  sudo docker exec -it $(sudo docker ps -a | grep pmm | grep 'Up.*pmm-server' | sed 's|[ \t].*||') cat /var/log/prometheus.log | grep -v '^$' | sed 's|^|  |'
  echo '==================== Extended info: cat /var/log/qan-api.log inside docker container:'
  sudo docker exec -it $(sudo docker ps -a | grep pmm | grep 'Up.*pmm-server' | sed 's|[ \t].*||') cat /var/log/qan-api.log | grep -v '^$' | sed 's|^|  |'
fi
