...
TESTS_PATH="/sda/mysql-5.7.8-rc-linux-glibc2.5-x86_64/mysql-test"           # Path to the msyql-test directory
FINAL_SQL=/tmp/mtr_to_sql.sql                                             # pquery final SQL grammar
...
cat ${TESTS_PATH}/*/*.test ${TESTS_PATH}/*/*/*.test ${TESTS_PATH}/*/*/*/*.test ${TESTS_PATH}/*/*/*/*/*.test | \
 sed 's/|/;\n/g' | \
 sed 's/$$/;\n/g' | \
