...
MAKE_THREADS=16      # Number of build threads. There may be a bug with >1 settings
WITH_ROCKSDB=0      # 0 or 1  # Please note when building the facebook-mysql-5.6 tree this setting is automatically ignored
