...
query:
	...
	bitmap | bitmap | bitmap | bitmap | bitmap | bitmap | bitmap | bitmap | bitmap | bitmap | bitmap |
	bitmap | bitmap | bitmap | bitmap | bitmap | bitmap | bitmap | bitmap | bitmap | bitmap_ods | bitmap_ods ;
...
bitmap:
	...
	FLUSH ALL CHANGED PAGE BITMAPS | FLUSH ALL CHANGED PAGE BITMAPS | 
	RESET ALL CHANGED PAGE BITMAPS | RESET ALL CHANGED PAGE BITMAPS |
	PURGE ALL CHANGED PAGE BITMAPS BEFORE _digit | PURGE ALL CHANGED PAGE BITMAPS BEFORE _digit |
	SET GLOBAL INNODB_CHANGED_PAGES_LIMIT = _digit |
	SET GLOBAL INNODB_CHANGED_PAGES_LIMIT = 0 ;

bitmap_ods:
	PURGE ALL CHANGED PAGE BITMAPS BEFORE 0 | PURGE ALL CHANGED PAGE BITMAPS BEFORE 1 |
	PURGE ALL CHANGED PAGE BITMAPS BEFORE -1 | PURGE ALL CHANGED PAGE BITMAPS BEFORE 18446744073709551615 |
	SET GLOBAL INNODB_CHANGED_PAGES_LIMIT = -1 | SET GLOBAL INNODB_CHANGED_PAGES_LIMIT = 18446744073709551615 |
