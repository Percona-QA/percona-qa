...
$INSTALL_DIR/bin/psql  -d sbtest2 -c"SELECT pg_tde_add_database_key_provider_kmip('kmip_keyring4','0.0.0.0',5696,'/tmp/certs/root_certificate.pem','/tmp/certs/client_key_jane_doe.pem');"
...
$INSTALL_DIR/bin/psql  -d sbtest6 -c"SELECT pg_tde_add_database_key_provider_kmip('kmip_keyring6','0.0.0.0',5696,'/tmp/certs/root_certificate.pem','/tmp/certs/client_key_jane_doe.pem');"
...
echo "Change Key provider to kmip"
$INSTALL_DIR/bin/psql  -d db8_new -c"SELECT pg_tde_add_database_key_provider_kmip('keyring_kmip','0.0.0.0',5696,'/tmp/certs/root_certificate.pem','/tmp/certs/client_key_jane_doe.pem');"
