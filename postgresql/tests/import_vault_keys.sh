...
$INSTALL_DIR/bin/psql -d postgres -c"SELECT pg_tde_add_database_key_provider_vault_v2('local_vault_provider', '$filename', '$vault_url', '$secret_mount_point', '$vault_ca')"
...
echo "SELECT pg_tde_change_database_key_provider_vault_v2('local_vault_provider', '$filename', '$vault_url', '$secret_mount_point', '$vault_ca')"
$INSTALL_DIR/bin/psql -d postgres -c"SELECT pg_tde_change_database_key_provider_vault_v2('local_vault_provider', '$filename', '$vault_url', '$secret_mount_point', '$vault_ca')"
