# Fortanix DSM setup for pg_tde KMIP testing
...
See also [kmip_test_coverage.md](kmip_test_coverage.md) and
...
- Percona QA: [kmip.md](kmip.md), [kmip_revalidation.md](kmip_revalidation.md)
