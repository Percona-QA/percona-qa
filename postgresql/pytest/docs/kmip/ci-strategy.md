# KMIP CI strategy — Cosmian in every build, vendors on schedule
...
See [vendor-signoff.md](vendor-signoff.md) § QA sign-off table. Record pg_tde version, branch, date, and owner per vendor.
...
- [quickstart.md](quickstart.md) — env vars, test map
- [vendor-signoff.md](vendor-signoff.md) — checklist steps
