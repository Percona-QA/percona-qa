# KMIP quickstart — Cosmian install, env vars, run tests
...
**Full test catalog:** [test-catalog.md](test-catalog.md).

**Fortanix DSM lab setup:** [vendor-lab-fortanix.md](vendor-lab-fortanix.md).
...
**[vendor-signoff.md](vendor-signoff.md)** and:
