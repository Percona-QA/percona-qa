# KMIP vendor sign-off — per-KMS revalidation checklist
...
| `fortanix` | Fortanix DSM | [Fortanix](https://docs.percona.com/pg-tde/global-key-provider-configuration/fortanix.html) · [Lab setup](vendor-lab-fortanix.md) | Scheduled / manual sign-off |
...
**Vendor lab** (export `KMIP_*` to a running server first — see [quickstart.md](quickstart.md)):
...
- [quickstart.md](quickstart.md) — Cosmian setup, env vars, test map
