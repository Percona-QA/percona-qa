# KMIP advanced scenarios — `test_kmip.py` class map
...
| | `test_kmip_global_default_principal_key_survives_repeated_restarts` | Same with 3 restarts (all `io_method` matrix values) |
