...
#     bash postgresql/bugs/PG-2609_repro_wal_encrypt_pgbackrest_ha_wal_symlink.sh
...
# Reproducing that here by moving pg_wal out to a sibling directory and symlinking it back,
# matching the operator's actual on-disk layout.
