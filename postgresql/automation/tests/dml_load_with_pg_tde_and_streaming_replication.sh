...
create_keys_and_insert_data() {
    ...
    sysbench /usr/share/sysbench/oltp_insert.lua --pgsql-user=`whoami` --pgsql-db=$DB_NAME --db-driver=pgsql --pgsql-port=$PRIMARY_PORT --threads=1 --tables=$TABLES --table-size=1000 prepare
