...
# Download OpenSSL 1.1.1 source needed for tarballs built with ssl1
...
sudo ./Configure linux-x86_64 --prefix=/opt/openssl-1.1 --openssldir=/opt/openssl-1.1 shared zlib
