...
BASEDIR="/sda//PS060117-percona-server-5.7.16-9-linux-x86_64-debug"   # Base directory (should contain mysql-test directory as a first level subdirectory, see TESTS_PATH)
