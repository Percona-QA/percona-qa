...
#
# Recommendations:
# - WL5004_data.zz should be used for the generation of some initial data.
...
# - The redefine file "WL5004_sql_redefine.yy" will increase the efficiency
#   of RQG runs and especially grammar simplifications by removing test variants
#   which should be checked by MTR based tests anyway.
...
alter_index_pk:
   ...
   # The template tables are create via the WL5004_data.zz grammar.
...
field:
   # Attention: The definition of this rule should fit to the tables created
   #            via WL5004_data.yy .
