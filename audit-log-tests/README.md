...
2018-03-06T10:37:46.409506Z 0 [Warning] TIMESTAMP with implicit DEFAULT value is deprecated. Please use --explicit_defaults_for_timestamp server option (see documentation for more details).
2018-03-06T10:37:47.726714Z 0 [Warning] InnoDB: New log files created, LSN=45790
2018-03-06T10:37:48.114572Z 0 [Warning] InnoDB: Creating foreign key constraint system tables.
2018-03-06T10:37:48.348165Z 0 [Warning] No existing UUID has been found, so we assume that this is the first time that this server has been started. Generating a new UUID: 69e0c53c-212a-11e8-bdf3-002590e9b448.
2018-03-06T10:37:48.379840Z 0 [Warning] Gtid table is not ready to be used. Table 'mysql.gtid_executed' cannot be opened.
2018-03-06T10:37:48.838475Z 0 [Warning] CA certificate ca.pem is self signed.
2018-03-06T10:37:48.898586Z 1 [Warning] root@localhost is created with an empty password ! Please consider switching off the --initialize-insecure option.
...
1 test, 0 failures
 ✓ running test select @@audit_log_format

1 test, 0 failures
 ✓ running test for audit_log_include_accounts='audited_user@localhost'
