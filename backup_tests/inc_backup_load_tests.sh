...
export xtrabackup_dir="$HOME/percona-xtrabackup-8.0.32-25-Linux-x86_64.glibc2.17/bin"
export mysqldir="$HOME/Percona-Server-8.0.31-23-Linux.x86_64.glibc2.28"
