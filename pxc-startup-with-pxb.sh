...
echo "    --mysqld=--keyring_file_data=/root/Percona-XtraDB-Cluster-5.7.11-rel4-25.14.1.Linux.x86_64/node1/mysqld.1/data/ \\" >> ./start_mtr
echo "   1st" >> ./start_mtr
echo " set -e" >> ./start_mtr
echo "popd" >> ./start_mtr
...
echo "    --mysqld=--log-output=none \\" >> ./start_mtr
echo "    --mysqld=--early-plugin-load=keyring_file.so \\" >> ./start_mtr
echo "    --mysqld=--keyring_file_data=/root/Percona-XtraDB-Cluster-5.7.11-rel4-25.14.1.Linux.x86_64/node2/mysqld.1/data/ \\" >> ./start_mtr
echo "   1st" >> ./start_mtr
echo " set -e" >> ./start_mtr
echo "popd" >> ./start_mtr
...
echo "    --mysqld=--log-output=none \\" >> ./start_mtr
echo "    --mysqld=--early-plugin-load=keyring_file.so \\" >> ./start_mtr
echo "    --mysqld=--keyring_file_data=/root/Percona-XtraDB-Cluster-5.7.11-rel4-25.14.1.Linux.x86_64/node3/mysqld.1/data/ \\" >> ./start_mtr
echo "   1st" >> ./start_mtr
echo " set -e" >> ./start_mtr
echo "popd" >> ./start_mtr
