...
keyring_vault_config=$BASEDIR/pxc-node/vault/keyring_vault_pxc1.cnf
...
plugin_dir=$BASEDIR/lib/mysql/plugin
early-plugin-load=keyring_vault.so
keyring_vault_config=$BASEDIR/pxc-node/vault/keyring_vault_pxc2.cnf
...
plugin_dir=$BASEDIR/lib/mysql/plugin
early-plugin-load=keyring_vault.so
keyring_vault_config=$BASEDIR/pxc-node/vault/keyring_vault_pxc3.cnf
