...
keyring_file_data=$WORKDIR/keyring_folder/keyring1
...
early-plugin-load=keyring_file.so
keyring_file_data=$WORKDIR/keyring_folder/keyring2
ssl-ca = $WORKDIR/cert/ca.pem
ssl-cert = $WORKDIR/cert/server-cert.pem
ssl-key = $WORKDIR/cert/server-key.pem
[client]
...
early-plugin-load=keyring_file.so
keyring_file_data=$WORKDIR/keyring_folder/keyring3
ssl-ca = $WORKDIR/cert/ca.pem
ssl-cert = $WORKDIR/cert/server-cert.pem
ssl-key = $WORKDIR/cert/server-key.pem
[client]
