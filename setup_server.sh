...
# For 18.04 (Bionic) you may also want to do this; https://sites.google.com/site/easylinuxtipsproject/swappiness - use 1 instead of 10 if you have SSD disks. Basically sudo vi /etc/sysctl.conf and add this line: vm.swappiness=1
