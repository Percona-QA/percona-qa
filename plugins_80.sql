# Remarked items will be added later (all or part) by Laurynas. They are remarked for early version testing.
system rmdir data/test  # Hack, ref bug https://bugs.mysql.com/bug.php?id=86282
CREATE DATABASE test;   # Hack, idem
