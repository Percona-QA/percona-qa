...
#MYEXTRA="--plugin-load-add=tokudb=ha_tokudb.so --init-file=${SCRIPT_PWD}/TokuDB.sql --tokudb-check-jemalloc=0"                       # Use for PS: TokuDB & audit-log testing
#MYEXTRA="--init-file=${SCRIPT_PWD}/plugins_55.sql"                                                                                   # PS 5.5: All plugins
#MYEXTRA="--plugin-load-add=tokudb=ha_tokudb.so --init-file=${SCRIPT_PWD}/plugins_56.sql --tokudb-check-jemalloc=0"                   # PS 5.6: All plugins
#MYEXTRA="--plugin-load-add=tokudb=ha_tokudb.so --init-file=${SCRIPT_PWD}/plugins_57.sql --tokudb-check-jemalloc=0"                   # PS 5.7: All plugins
