...
PQUERY_BIN=${SCRIPT_PWD}/pquery/pquery-ws                     # pquery/pquery-ps for Percona Server, .../pquery-ms for MySQL, .../pquery-md for MariaDB, pquery-ws for WebScaleSQL
INFILE=${SCRIPT_PWD}/pquery/main-ws.sql                       # Default: main-ms-ps-md.sql (mtr_to_sql.sh of all major distro's + engine mix)
...
BASEDIR=/sda/FB-mysql-5.6.24-linux-x86_64-dbg/                # Basedir. Note that even for PXC runs, a PS basedir is needed (we need mysql client, mysqladmin,...)
